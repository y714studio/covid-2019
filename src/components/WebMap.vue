    ...
    loadModules(
      ...
      ([
        ...
        for (let i = 0; i < this.sanityInfoCases.length; i++) {
          ...
          point.longitude = this.sanityInfoCases[i].lng;
          point.latitude = this.sanityInfoCases[i].lat;

          const attributes = {};

          attributes.Name = this.sanityInfoCases[i].name;
          attributes.Description = this.sanityInfoCases[i].description;
